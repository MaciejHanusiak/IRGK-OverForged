...
public class PlayerOne : MonoBehaviour, ISmithObjectParent
{
    ...
    [SerializeField] private Mp_InputPlayerOne gameInput;
    ...
    void Move()
    {
        ...
        Debug.Log($"moveDir={moveDir} canMove={canMove}");
    }
